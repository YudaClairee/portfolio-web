...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "React Native app with seamless shopping experience, payment integration, and offline-first architecture.",
      tech: ["React Native", "Redux", "Stripe", "SQLite"],
      image:
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] w-full overflow-hidden rounded-xl border border-border">
              <Image
                src="https://images.unsplash.com/photo-1518933165971-611dbc9c412d?q=80&w=1600&auto=format&fit=crop"
                alt="Workspace"
                loading="lazy"
